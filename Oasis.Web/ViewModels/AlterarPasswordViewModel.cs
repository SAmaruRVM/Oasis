...
namespace Oasis.Web.ViewModels
{
    ...
    {
        [Required(ErrorMessage = "A password atual tem que ser obrigatóriamente preenchida!")]
        [Display(Name = "A sua password atual", Prompt = "Introduza a sua password atual")]
        [DataType(DataType.Password)]
        public string Password { get; set; }

        [Required(ErrorMessage = "A nova password tem que ser obrigatóriamente preenchida!")]
        [Display(Name = "A sua nova password", Prompt = "Introduza a sua nova password")]
        [DataType(DataType.Password)]
        public string NovaPassword { get; set; }

        [Required(ErrorMessage = "A confirmação da nova password tem que ser obrigatóriamente preenchida!")]
